...
#     cursor.execute("""
#     CREATE TABLE sticky_column_boards (
#         id INTEGER PRIMARY KEY AUTOINCREMENT,
#         name TEXT,
#         description,
#         creation TEXT NOT NULL,
...
#         FOREIGN KEY (sticky_board_id) REFERENCES sticky_column_boards (id) ON DELETE CASCADE
#     );
#     """)
...
#         sticky_board_id INTEGER,
#         column_id INTEGER,
#         FOREIGN KEY (sticky_board_id) REFERENCES sticky_boards (id) ON DELETE CASCADE,
#         FOREIGN KEY (column_id) REFERENCES sticky_columns (id) ON DELETE CASCADE
#     );
#     """)
